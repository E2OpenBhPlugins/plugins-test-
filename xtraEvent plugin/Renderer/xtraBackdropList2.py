...
from enigma import ePoint, eWidget, eLabel, eSize, gFont, ePixmap, loadJPG, eEPGCache, addFont
			...
			if what[0] != self.CHANGED_CLEAR:
				...
				if event:
					...
					if rate:	
						rtd = str(rate)
					if rtd:
						rateNm = pratePath + "FSK_{}.png".format(rtd)
					...
					if self.epgcache is not None and events:
						try:
							...
							self.eventName0.setFont(gFont("Regular", 26))
						...
						try:
							...
							self.eventDesc.setFont(gFont("Regular", 26))
						...
						try:
							...
							self.eventName1.setFont(gFont("Regular", 22))
						...
						try:
							...
							self.eventName2.setFont(gFont("Regular", 22))
						...
						try:
							...
							self.eventName3.setFont(gFont("Regular", 22))
